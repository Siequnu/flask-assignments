from flask import send_from_directory, current_app, render_template, url_for
...
def send_async_assignment_notification_to_class(app, usernames_and_emails, class_id, assignment_title, assignment_url, app_name):
    with app.app_context():

        from app.email_model import send_email
        subject = f"{app_name} - you have a new assignment!"
        for user in usernames_and_emails:
            body = render_template(
                'email/new_assignment.html',
